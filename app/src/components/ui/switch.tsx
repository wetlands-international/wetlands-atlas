...
function Switch({ className, ...props }: React.ComponentProps<typeof SwitchPrimitive.Root>) {
  return (
    <SwitchPrimitive.Root
      data-slot="switch"
      className={cn(
        "peer focus-visible:border-ring focus-visible:ring-ring/50 inline-flex h-4 w-8 shrink-0 cursor-pointer items-center rounded-full border-0 p-0 outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50",
