...
export const Hero = () => {
  return (
    <div className="relative grid min-h-[calc(100svh_-_theme(spacing.16))] items-center justify-items-center overflow-hidden">
      <Circle size="large" className="absolute top-[10%] left-[10%]" />
      <Circle
        size="medium"
      ...
      <Circle
        size="small"
        className="absolute top-[82%] left-[20%]"
      ...
      />
      <Circle size="small" className="absolute top-[10%] left-[90%]" />
      <Circle size="large" className="absolute top-[90%] left-[20%]" enableAnimation={false} />
